...
public class Heap<E> {
    ...
    class Element {
        ...
        protected long priority;   // The priority

        /** An instance with value v and priority p. */
        protected Element(E v, long p) {
            val= v;
            priority= p;
        }
    ...
    public void add(E v, long p) throws IllegalArgumentException {
    ...
    public int compareTo(long p1, long p2) {
        if (p1 == p2) return 0;
    ...
    public void updatePriority(E v, long p) {
